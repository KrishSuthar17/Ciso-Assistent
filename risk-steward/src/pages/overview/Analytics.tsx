    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-6">
        ...
        <div className="flex space-x-4 border-b mb-6">
          ...
          <Link to="/analytics/governance" className="...">Governance</Link>
          <Link to="/analytics/risk" className="...">Risk</Link>
          <Link to="/analytics/compliance" className="...">Compliance</Link>
        </div>
